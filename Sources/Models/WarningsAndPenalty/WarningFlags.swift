...
struct WarningFlags: OptionSet {
    ...
    static let QUERY_PERSONAL_INFORMATION = WarningFlags(rawValue: 1 << 27) //not used atm, need to be added to email leaks 
    ...
    static let BODY_HTML_MALFORMED = WarningFlags(rawValue: 1 << 34)
    ...
    //COOKIE FLAGS
    static let COOKIE_TRACKING  = WarningFlags(rawValue: 1 << 44)
    static let COOKIE_DANGEROUS = WarningFlags(rawValue: 1 << 45)
    static let COOKIE_JS_ACCESS = WarningFlags(rawValue: 1 << 46)
    ...
    static let HEADERS_MISSING_HSTS = WarningFlags(rawValue: 1 << 56)
...
//    static let HEADERS_CSP_UNSAFE_INLINE_CONTAINED = WarningFlags(rawValue: 1 << 60) // This is wrong babylon mon RTFM
