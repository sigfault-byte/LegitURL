    ...
    public static func instructions(brief: Bool) -> [String: Any] {
        if !brief {
            return [
                ...
                "04_script_reasoning": "If JavaScript snippets are present, analyze them to distinguish common frontend logic from suspicious patterns. Scripts without Subresource Integrity (SRI), especially from third-party or protocol-relative URLs, should be flagged as risky. These can be abused if a CDN is compromised.",
